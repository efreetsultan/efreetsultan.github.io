...
async function getData() {
    loadData();
    await fetch(`https://api.weatherapi.com/v1/current.json?q=${LOCATION_NAME}&key=${WEATHER_API_KEY}`)
    ...
    await fetch(`https://api.weatherapi.com/v1/astronomy.json?q=${LOCATION_NAME}&key=${WEATHER_API_KEY}`)
        .then(response => response.json())
        .then(data => {
    ...
    await fetch(`https://api.weatherapi.com/v1/forecast.json?q=${LOCATION_NAME}&key=${WEATHER_API_KEY}`)
        .then(response => response.json())
        .then(data => {
